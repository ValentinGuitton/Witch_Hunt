    ...
    //choix d'avoir des bots ou non
    	...
    	if (choix == 'A') {
        	...
        	if (réponse=='W') {
        		...
        		System.out.println("Joueur "+accusé+" voici vos cartes :");
        		...
        		PartieV2.partieUnique.jouerjoueur.get(actuel).main.get(idchoisie).jouerCarte(nomcarte,false);
        	}
        	else {
        		...
        		if(PartieV2.partieUnique.jouerjoueur.get(accusé).witch==true) {
        			...
        			System.out.println("Joueur "+accusé+" c'est votre tour");
        			actuel=accusé;
        		}
        	}
    		}
