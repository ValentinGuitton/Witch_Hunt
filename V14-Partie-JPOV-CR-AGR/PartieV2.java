...
//    	int nbjp=0;
    ...
    //choix d'avoir des bots ou non
    	...
    	if (choix == 'A') {
    		...
    		if(accusé>=0 && accusé<(PartieV2.partieUnique.getnbBots()+PartieV2.partieUnique.getnbJoueursPhys()) && accusé != actuel && PartieV2.partieUnique.jouerjoueur.get(accusé).révélé==false && PartieV2.partieUnique.jouerjoueur.get(accusé).peutEtreAccusé==true && PartieV2.partieUnique.jouerjoueur.get(accusé).enJeu==true && PartieV2.partieUnique.jouerjoueur.get(accusé).getBot()==false) {
    		...
    		if(PartieV2.partieUnique.jouerjoueur.get(accusé).getBot()==true)
    		{
    			PartieV2.partieUnique.jouerjoueur.get(accusé).setEstAccusé(true);
    			PartieV2.partieUnique.jouerjoueur.get(accusé).sonTour=true;
    			Agressive.jouerBot(PartieV2.partieUnique.jouerjoueur.get(accusé)); 
    		}
    			else {
