...
public class IG_witch_hunt implements Observer{
	...
	public IG_witch_hunt(PartieV2 partie) {
		...
		txtarea.setBounds(10, 355, 893, 68);
	...
	private void initialize() {
		...
		textField_5.setBounds(10, 258, 893, 43);
		...
		txtpnEffetWitch.setBounds(10, 239, 99, 20);
		...
		textField_6.setBounds(10, 429, 242, 20);
		...
		txtpnNombreDeJoueurs.setBounds(0, 457, 192, 20);
		frame.getContentPane().add(txtpnNombreDeJoueurs);
		
		textField_7 = new JTextField();
		textField_7.setBounds(192, 457, 30, 20);
